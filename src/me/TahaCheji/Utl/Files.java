...
public class Files {
	...
	static File configFile = new File("plugins/MafanaBank/config.yml");
	...
	public static void initFiles() throws FileNotFoundException, IOException, InvalidConfigurationException {
		...
		if(!new File("plugins/MafanaBank").exists()) {
			new File("plugins/MafanaBank").mkdir();
		}
		...
		File playerData = new File("plugins/MafanaBank/playerData");
